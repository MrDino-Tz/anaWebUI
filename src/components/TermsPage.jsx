  ...
  return (
    <div className="min-h-screen bg-bg-0 text-text-100 flex flex-col">
      ...
      <main className="flex-1 max-w-3xl mx-auto px-6 py-16">
        <h1 className="text-4xl font-medium text-white mb-2">Terms of Service</h1>
        ...
        <section className="space-y-6 text-[15px] leading-relaxed text-text-200">
          ...
          <h2 className="text-xl font-medium text-white mt-8 mb-4">3. User Responsibilities</h2>
          ...
          <h2 className="text-xl font-medium text-white mt-8 mb-4">4. AI-Generated Content</h2>
          <p>
          ...
          <h2 className="text-xl font-medium text-white mt-8 mb-4">5. Privacy</h2>
          <p>
            Your use of the Service is governed by our Privacy Policy, which is incorporated
            into these terms by reference.
          </p>

          <h2 className="text-xl font-medium text-white mt-8 mb-4">6. Limitation of Liability</h2>
          <p>
          ...
          <h2 className="text-xl font-medium text-white mt-8 mb-4">7. Termination</h2>
          <p>
          ...
          <h2 className="text-xl font-medium text-white mt-8 mb-4">8. Changes to Terms</h2>
          <p>
          ...
          <h2 className="text-xl font-medium text-white mt-8 mb-4">9. Contact</h2>
          <p>
            For questions about these terms, contact us at{' '}
            <a href="mailto:legal@anagpa.com" className="text-text-200 hover:text-white underline">
              legal@anagpa.com
            </a>.
          </p>
        </section>
